...
const projectNav = [
  ...
  { path: 'procurement',icon: DollarSign,      label: 'Procurement',sprint: 5,  soon: true },
  { path: 'kanban',     icon: KanbanSquare,    label: 'Kanban',     sprint: 6,  soon: true },
  { path: 'progress',   icon: TrendingUp,      label: 'Progress',   sprint: 7,  soon: true },
  { path: 'diary',      icon: BookOpen,        label: 'Site Diary', sprint: 8,  soon: true },
